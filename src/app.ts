...
const whiteLists = process.env.NODE_ENV === 'production' ? ['https://easyteach.quirky-craft.com', 'http://easyteach.quirky-craft.com'] : ['http://localhost', 'http://localhost:8080', 'http://192.168.43.21:8080'];
